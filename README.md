---
description: pWS is a free and scalable open-source alternative for the Pusher service. 📡
---
...
pWS implements the [Pusher Protocol v7](https://pusher.com/docs/channels/library\_auth\_reference/pusher-websockets-protocol#version-7-2017-11) - meaning that any Pusher-maintained client can connect to it, bringing portability and plug-and-play functionality with already frontend apps that you may already be implementing.
